...
all: rds-payload-generator ## Build all binaries

rds-payload-generator: ## Build rds-payload-generator binary
	go build rds-payload-generator.go

install: ## Install all binaries
	cp rds-payload-generator /usr/bin/rds-payload-generator

uninstall: ## Uninstall all binaries
	rm -f /usr/bin/rds-payload-generator
...
deps: git-config ## Download dependencies
	...
	go get -d -v pkg.re/essentialkaos/redy.v4
